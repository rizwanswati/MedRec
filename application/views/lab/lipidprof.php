<?php include dirname(__DIR__).'/info_lab.php'; ?>
    ...
    <?php if($info){
        foreach ($info as $row){?>
            <tr>
                ...
                <td style="text-align: center;height: 55px;width: 0px;"><a class="btn btn-success" style=" height: 48px" href="<?=base_url('lab/updateLipid/'.$row['lp_id']);?>" role="button">Update</a></td>
                <td style="text-align: center;height: 55px;width: 0px;"><a class="btn btn-danger" style=" height: 48px" href="<?=base_url('lab/deleteLipid/'.$row['lp_id']);?>" role="button">Delete</a></td>
            </tr>
        <?php } }?>
    </tbody>
</table>
