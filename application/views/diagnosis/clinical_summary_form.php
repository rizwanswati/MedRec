...
<div class="wrapper wrapper--w960">
    <div class="card card-5">
        ...
        <div class="card-body">
            ...
            <?php echo form_open('diagnosis/clinical_summary_form'); ?>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <?=form_textarea(['class'=>"input--style-5",'rows'=>"5",'cols'=>"80",'name'=>"clinical_s", 'required'=>"required",'value'=>set_value('clinical_s')]);?>
