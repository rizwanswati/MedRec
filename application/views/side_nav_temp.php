            ...
            <li>
                ...
                <ul class="collapse list-unstyled" id="home">
                    <li><a href="#patient" data-toggle="collapse" aria-expanded="false"><strong>Patient</strong></a>
                        <ul class="collapse list-unstyled" id="patient" style="margin-left: 10px">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="binfo">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="diag">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?=form_open('search/find', array('class' => 'search-form','role' => 'search'));?>
                            <div class="form-group pull-right" id="search">
                                <?=form_input(['class'=>"form-control",'name'=>"raw",'placeholder'=>"Database Search",'required'=>"required",'type'=>"text"]);?>
