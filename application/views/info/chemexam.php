...
<table id="myTable" style="margin-top: -15px">
    ...
    <tr class="table100-head">
        ...
        <th style="text-align: center">ESR</th>
        <th style="text-align: center">Vit-D Level</th>
    ...
    <?php if($info){
        foreach ($info as $row){?>
            <tr>
                ...
                <td style="text-align: center"><?=$row['vitd'];?></td>
                <td style="text-align: center"><?=$row['other'];?></td>
                <td style="text-align: center"><?=$row['date'];?></td>
                <td style="text-align: center;height: 55px;width: 0px;"><a class="btn btn-success" style=" height: 48px" href="<?=base_url('Chemicalexam/updateBioChemRep/'.$row['b_id']);?>" role="button">Update</a></td>
                <td style="text-align: center;height: 55px;width: 0px;"><a class="btn btn-danger" style=" height: 48px" href="<?=base_url('Chemicalexam/deleteBioChemRep/'.$row['b_id']);?>" role="button">Delete</a></td>
            </tr>
        <?php } }?>
    </tbody>
</table>
